...
This is an **ArcKit architecture governance project** — not a software codebase. It generates architecture documents (markdown) for the **Legal AI & Litigation Intelligence Platform** at Government Legal Department.
...
Expected artifacts for project 001 (Legal AI & Litigation Intelligence Platform):
...
The Government Legal Department (GLD) is the largest provider of legal services to government, providing legal advice to most government departments and agencies. GLD handles litigation, advisory work, legislative drafting support, and employment law. AI can significantly enhance legal research, document review, case management, and legislative analysis while maintaining the rigorous accuracy standards required in legal practice.

### Compliance Context

UK Government non-ministerial department. Applicable frameworks: GDS Service Standard, Technology Code of Practice (TCoP), NCSC Cyber Assessment Framework, ATRS for AI tools, UK GDPR (legal professional privilege considerations), HM Treasury Green Book, AI Playbook, Legal Services Act, SRA Code of Conduct equivalents.

### Key Stakeholders

GLD (service owner), Treasury Solicitor, government departments (clients), Attorney General's Office, Parliamentary Counsel, Law Officers, judiciary, legal profession, Law Commission.
